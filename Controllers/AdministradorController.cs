...
namespace GerenciamentoMensalidade2.Controllers
{
    public class AdministradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdministradorId,Nome,Cpf,Email,Senha")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdministradorId,Nome,Cpf,Email,Senha")] Administrador administrador)
        {
